...
## extends HttpRouter
##
## func handle_get(request: RESTHttpRequest, response: RESTHttpResponse) -> void:
##     response.send(200, "Hello World")
## [/codeblock]
class_name RESTHttpRouter
extends RefCounted
...
## [br][param response] - The node to send the response back to the client
@warning_ignore("unused_parameter")
func handle_head(request: RESTHttpRequest, response: RESTHttpResponse) -> void:
...
## [br][param response] - The node to send the response back to the client
@warning_ignore("unused_parameter")
func handle_patch(request: RESTHttpRequest, response: RESTHttpResponse) -> void:
...
## [br][param response] - The node to send the response back to the client
@warning_ignore("unused_parameter")
func handle_options(request: RESTHttpRequest, response: RESTHttpResponse) -> void:
